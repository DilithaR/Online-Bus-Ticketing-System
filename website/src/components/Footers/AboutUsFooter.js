        ...
        <>
            <div className="page-header page-header-small">
                    ...
                    <Container>
                        <Row>
                            <Col className="text-left" md="8">
                                ...
                                <p className="text">
                                    Enjoy world-class service amidst tranquil surroundings, coupled with inspirational
                                    design and transformative experiences in some of the world's finest urban addresses
                                    and resort destinations. </p>
                ...
                <div
                    ...
                    style={{
                        backgroundImage:
                            "url(" + require("assets/img/aboutusfooter.jpg").default + ")",
                    }}
                ></div>
            </div>
